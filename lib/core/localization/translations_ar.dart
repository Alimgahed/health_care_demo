...
const Map<String, String> translationsAr = {
  ...
  'national_registry': 'السجل الوطني',
  ...
  'ncc_brand': 'المركز الوطني للقيادة',
  ...
  'admin_embed_clinical_sub':
      'نفس أدوات بوابة الطبيب: سجل المستفيدين، ملف 360°، خطط الرعاية، الأهلية، التسجيل، ومراجعات الاعتماد.',
  'admin_embed_dispensing_title': 'عمليات الصرف',
  'admin_embed_dispensing_sub':
      'نفس أدوات منشأة الصرف في {center}: الصرف، المخزون، السجلات، الأهلية، ومسار الدعم.',

  'demo_workflow_title': 'برنامج الرعاية الصحية — دورة العرض الكاملة',
  'demo_workflow_subtitle':
      'اعرض المسار كاملاً: إشراف الوزارة ← بوابة الطبيب المعالج ← منشأة الصرف ← تطبيق المستفيد ← التدقيق.',
  'demo_role_admin': 'الوزارة (المسؤول)',
  'demo_role_doctor': 'الطبيب المعالج',
  'demo_role_center': 'منشأة الصرف',
  'demo_role_patient': 'تطبيق المستفيد',
  ...
  'demo_patient_focus': 'المستفيد للتركيز: {name} ({id})',
  ...
  'national_command_center': 'المركز الوطني للقيادة',

  'exec_summary': 'الملخص التنفيذي',
  'registered_patients_national': 'المستفيدون المسجلون (وطنياً)',
  ...
  'active_dispensing_centers': 'منشآت الصرف المعتمدة',
  ...
  'demographics_title': 'التوزيع الديموغرافي للمستفيدين',
  ...
  'center_inventory_sub': 'المخزون اللحظي في منشآت الصرف',
  'active_patients_legend': 'المستفيدون النشطون',
  ...
  'contact_centers': 'التواصل مع منشآت الصرف',
  'action_executed': 'تم تنفيذ الإجراء: {title}',
  'ministry_health': 'وزارة الصحة ووقاية المجتمع',

  'geo_analytics': 'التحليل الجغرافي',
  'select_marker': 'اختر علامة على الخريطة لعرض تفاصيل المنشأة أو المستفيد',
  'patient_details': 'بيانات المستفيد',
  'center_details': 'بيانات منشأة الصرف',
  ...
  'active_patients_rehab': 'المستفيدون النشطون في التأهيل',
  'working_hours': 'ساعات العمل',
  'services_offered': 'الخدمات المقدمة',
  'filter_all': 'الكل',
  'filter_patients': 'المستفيدون',
  'filter_pharmacies': 'منشآت الصرف',
  ...
  'patients_registry': 'سجل المستفيدين',
  'clinical_assessments': 'مراجعات الاعتماد',
  ...
  'request_override_dispense': 'طلب تجاوز معتمد وصرف العلاج',
  'confirm_verify_dispense': 'تأكيد التحقق وصرف العلاج',
  ...
  'patient_pay_line': 'مساهمة المستفيد',
  ...
  'dispense_success': 'تم صرف الرعاية الصحية للمستفيد {name}.',
  ...
  'patient_portal_title': 'بوابة المستفيد',
  ...
  'patients_registry_title': 'سجل المستفيدين',
  'no_matching_patients': 'لا يوجد مستفيدون مطابقون',
  'patients_list_subtitle': 'الهوية',
  'main_nav_dashboard': 'لوحة القيادة',
  'main_nav_patients': 'المستفيدون',
  'main_nav_dispensing': 'صرف العلاج',
  'main_nav_patient_app': 'تطبيق المستفيد',
  ...
  'total_patients': 'المستفيدون المسجلون',
  ...
  'assessments_log': 'سجل مراجعات الاعتماد',
  ...
  'total_active_patients': 'المستفيدون المسجلون (وطنياً)',
  ...
  'ncc_title': 'المركز الوطني للقيادة',
  ...
  'patient_greeting': 'بوابة المستفيد',
  ...
  'patient_360_view': 'عرض المستفيد 360°',
  'cardio': 'تمارين قلبية وعائية',
  'strength': 'تمارين مقاومة',
  'flexibility': 'المرونة',
  'category': 'الفئة',
  'nearest_centers': 'أقرب المراكز',
  'nearest_centers_sub': 'عرض {count} أقرب منشآت للمستفيد ({emirate})',
  ...
  'gender': 'الجنس',
  'nationality': 'الجنسية',
  'clinical_assessments_dashboard': 'مراجعات الاعتماد',
  ...
  'patient_registered_title': 'تم تسجيل المستفيد',
  ...
  'patient_sidebar_label': 'المستفيد',
  ...
  'duplicate_dispense_detail':
      'تلقى هذا المستفيد الرعاية الصحية بتاريخ {date}. يتطلب أي صرف إضافي تجاوزاً طبياً معتمداً.',
  'last_dispense_date': 'تاريخ آخر صرف',
  'patient_copay_collect': 'مساهمة المستفيد المستحقة',
  ...
  'override_duplicate_warning':
      'يشير تنبيه السلامة إلى احتمال صرف دواء مكرر لهذا المستفيد. يتطلب المتابعة مبرراً طبياً.',
  ...
  'dispense_pending_clinical_msg':
      'الصرف المبكر يتطلب اعتماد الطبيب (الموعد التالي: {date}). اعتمد من «مراجعات الاعتماد» ثم ارجع للصرف.',
  ...
  'clinical_assessments_dashboard_sub':
      'اعتماد خطط الرعاية والصرف المبكر — مع السجل الطبي الكامل للمستفيد.',
  ...
  'wizard_pickup': 'استلام من منشأة الصرف',
  'wizard_delivery': 'التوصيل المنزلي',
  'wizard_avail_pharmacies': 'منشآت الصرف المتوفرة',
