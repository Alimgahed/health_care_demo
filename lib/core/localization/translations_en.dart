...
const Map<String, String> translationsEn = {
  ...
  'program_dispensing_section': 'Program & dispensing',
  'patient_overview_snapshot': 'Beneficiary status snapshot',
  ...
  'exercise_total_summary': '{mins} total minutes • {count} exercises',
  'exercise_better_than_avg': '🏆 Better than 78% of patients!',
  'exercise_days_count': '{days}/7 days',
  'exercise_all_done': '🎉 All exercises completed!',
  'exercise_progress_count': '{completed} of {total} exercises completed',
  'exercise_calories_burned': '~{calories} kcal',
  'exercise_count_label': '{count} exercises',
  'exercise_minutes_short': '{mins} min',
  'exercise_sets_short': '{sets} sets',
  'exercise_reps_short': '{reps} reps',
  ...
  'treatment_duration': 'Plan Duration',
  'sessions_count': '{count} Sessions',
  'treatment_type_label': 'Treatment Type',
  'nutritional_therapy': 'Nutritional Therapy',
  ...
  'weight_lost': 'Lost {weight} kg',
  'weight_to_go': '{weight} kg to go',
  ...
  'mounjaro_weekly': 'Mounjaro (Tirzepatide) — Weekly Injection',
  'next_mounjaro_dose': 'Next Mounjaro Dose',
  ...
  'dosage_information': 'Mounjaro — Dosage Information',
  ...
  'abdomen_thigh_arm': 'Abdomen / Thigh / Upper Arm',
  'storage': 'Storage',
  'refrigerated': '2°C – 8°C (Refrigerated)',
  'manufacturer': 'Manufacturer',
  'eli_lilly': 'Eli Lilly',
  'tab_history': 'History',
  'tab_schedule': 'Schedule',
  'tab_side_effects': 'Side Effects',
  'week_n': 'Week {n}',
  'days_ago': '{n} days ago',
  'abdomen': 'Abdomen',
  'thigh': 'Thigh',
  ...
  'track_therapy_journey': 'Track your therapy journey',
  'overall_progress': 'Overall Progress',
  'session_completed': '{completed} of {total} sessions',
  'percent_complete': '{percent}% complete',
  'sessions_remaining': '{remaining} remaining',
  'current_streak_label': 'Current Streak',
  'sessions_in_a_row': 'Sessions in a row {count}',
  ...
  'doses_count': '{count} doses',
  'upper_arm': 'Upper Arm',
  'mounjaro_pen_refill': 'Mounjaro Pen Refill',
  'pens_left': '{count} auto-injector pens left',
